...
exports.genre_list = function(req, res) {
    Genre.find().exec(function(err, genre_list){
        ...
        res.render('genre_list',{genre_list:genre_list, title : 'The list of genres'})
    }) 
};
...
exports.genre_detail = function(req, res,next) {
    ...
    function(err, results){
        ...
        return res.render('genre_detail',{genre:results.genre, books:results.genre_books, title:"The detail about genre"})
    }
